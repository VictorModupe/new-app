...
const SplashPushNotifications = () => {
  return (
    <View style={styles.splashPushNotifications1}>
      <Image
      ...
      <Image
        ...
        contentFit="cover"
        source={require("../assets/intro--notificationss.png")}
      />
      ...
      <Text style={[styles.knowWhenBeers1, styles.knowWhenBeers1Position]}>
        Know when beers are released
      </Text>
      <Text style={[styles.customizedPushNoti, styles.knowWhenBeers1Position]}>
...
export default SplashPushNotifications;
